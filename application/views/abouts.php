 <!-- ##### Breadcumb Area Start ##### -->
    <div class="breadcumb-area bg-img bg-overlay" style="background-image: url(<?php echo base_url();?>assets/img/bg-img/breadcumb.jpg);">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-5">
                    <div class="about--thumb">
                        <img src="<?php echo base_url();?>assets/img/bg-img/bg-12.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="cool-facts-area section-padding-100-0 bg-img bg-overlay" style="background-image: url(<?php echo base_url();?>assets/img/bg-img/bg-13.jpg);">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-cool-fact text-center mb-100">
                        <img src="<?php echo base_url();?>assets/img/core-img/stationary-bike2.png" alt="">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-cool-fact text-center mb-100">
                        <img src="<?php echo base_url();?>assets/img/core-img/chronometer.png" alt="">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-cool-fact text-center mb-100">
                        <img src="<?php echo base_url();?>assets/img/core-img/beef.png" alt="">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-cool-fact text-center mb-100">
                        <img src="<?php echo base_url();?>assets/img/core-img/swimming2.png" alt="">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area mb-100">
                        ...
                        <!-- Thumbnail -->
                        <div class="teachers-thumbnail">
                            <img src="<?php echo base_url();?>assets/img/team-img/t2.png" alt="">
                        </div>
                        <!-- Meta Info -->
                        <div class="teachers-info">
                            <h6>Mick Hamilton</h6>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area mb-100">
                        ...
                        <!-- Thumbnail -->
                        <div class="teachers-thumbnail">
                            <img src="<?php echo base_url();?>assets/img/team-img/t3.png" alt="">
                        </div>
                        <!-- Meta Info -->
                        <div class="teachers-info">
                            <h6>Criss James</h6>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area mb-100">
                        ...
                        <!-- Thumbnail -->
                        <div class="teachers-thumbnail">
                            <img src="<?php echo base_url();?>assets/img/team-img/t4.png" alt="">
                        </div>
                        <!-- Meta Info -->
                        <div class="teachers-info">
                            <h6>Jack Black</h6>
